     ...
     <html>
        ...
        <body>
           <div class="invoice-box">
             ...
             <p class="underline seventy grey">THANK YOU FOR REGISTERING WITH LOGLY TECHNOLOGY. WELCOME TO OUR CIRCLE OF LOVE</p>	
             <p class="grey">Care Giver ID: ${uid}</p>
             <p class="grey">Verification Code :<h3 class="grey">${code}</h3> </p>
