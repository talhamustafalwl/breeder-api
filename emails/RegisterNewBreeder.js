       ...
       <body>
          <div class="invoice-box">
           <div>
            ...
            <p class="underline seventy grey">YOU HAVE BEEN REGISTERED BY A BREEDER. WELCOME TO OUR CIRCLE OF LOVE</p>
            <p class="grey">User Name: <b>${username}</b></p>
            <p class="grey">Password: <b>${password}</b></p>
