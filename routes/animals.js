...
router.post(
  ...
  AnimalController.uploadGalleryImage
);
router.put(
  "/gallery/delete",
  auth,
  ...
  allowEmployee,
  authenticateRole,
  AnimalController.deleteGallaryImage
);
...
router
  ...
  .get(
    ...
    allowEmployee,
    authenticateRole,
    AnimalController.getBreederAnimals
  )
  .delete(
    auth,
    allowBreeder,
    authenticateRole,
    AnimalController.deleteBreederAnimals
  )
  .post(
    auth,
    allowBreeder,
    ...
    upload.single("file"),
    AnimalController.addBreederAnimals
  );
...
router.post(
  ...
  AnimalController.uploadHealthRecord
);

router.get("/healthrecord/:id", AnimalController.getHealthRecord);
router.delete(
  "/:animalId/healthrecord/:id",
  AnimalController.deleteAnimalHealthRecord
);
